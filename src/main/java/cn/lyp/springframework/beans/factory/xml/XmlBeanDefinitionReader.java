package cn.lyp.springframework.beans.factory.xml;
...
import cn.lyp.springframework.beans.factory.support.AbstractBeanDefinitionReader;
import cn.lyp.springframework.beans.factory.support.BeanDefinitionRegistry;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    /**
     * 解析 xml
     * 对xml的读取 XmlUtil.readXML(inputStream) 和元素 Element 解析。在解析的过程中通过循环操作
     * 以此获取 Bean 配置以及配置中的 id、name、class、value、ref 信息。
     * @param inputStream
